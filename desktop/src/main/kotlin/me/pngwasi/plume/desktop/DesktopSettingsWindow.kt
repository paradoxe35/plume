...
/**
 * macOS decides a process's access once per launch, so a granted privilege can go on reading as
 * missing. Without a way out the card is a dead end: grant, nothing happens, grant again.
 */
